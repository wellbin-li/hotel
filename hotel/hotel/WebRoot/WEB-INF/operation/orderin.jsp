...
<html>
  ...
  <body>
  	<form id="ff" method="post">   
	    ...
	    <!-- 客房状态在后台直接修改 -->    
	    <div>   
	        <label for="client">添加顾客:</label>   
	        <input id="gk" type="text" name="client.cid"/>   
	    </div>    
	    <div>   
	        <label for="rdate">入住日期:</label>   
	        <input type="text" name="rdate" class="easyui-datebox" required="true" />   
	    </div>    
	    <div>   
	        <label for="rnumber">入住天数:</label>   
	        <input type="text" name="rnumber" class="easyui-validatebox" validType="integer" required="true"/>   
	    </div>    
	    <div id="cash">   
	        <label for="rcash">押金:</label>   
	        <input type="text" name="rcash" />   
	    </div>    
	    <div id="fee">   
	    ...
	    <div>
	    	<a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">预订</a>
