  ...
  <head>
	...
	<body class="easyui-layout">   
	    <div id="top" data-options="region:'north'" style="height:100px;">
	       当前登录用户：<font color="red" >${nowuser.uname}</font>
			    ...
			    <div title="&nbsp;&nbsp;基本操作">   
			        <ul>
			        	...
			        	<li><a class="privilege" href="#" title="send_room_query.action">客房信息管理</a></li>
				  		...
				  		<li><a class="privilege" href="#" title="send_business_sale.action">客房业务统计</a></li>
				  		<li><a class="privilege" href="#" title="send_business_income.action">营业收入统计</a></li>
	  				</ul>   
			    </div>   
			    <div title="&nbsp;&nbsp其它操作">   
			        <ul>
	    ...
	    <div id="bottom" data-options="region:'south'">
	    	<font>Copyright © 湖北工程学院计算机与信息科学学院——毕业设计（李文滨） 版权所有</font>
	    </div> 
